                            ...
                            <div class="row">
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="section-header">
                                        <h2 class="pricing-title">Our Menu List in Affordable Price</h2>
                                        <ul id="filter-list" class="clearfix">
                                            <li class="filter" data-filter="all">All</li>

                                            @foreach($categories as $category)
                                            <li class="filter" data-filter="#{{$category->slug}}">
                                            {{$category->slug}} <span class="badge">{{$category->items->count()}}</span></li>
                                            @endforeach
                                        </ul><!-- @end #filter-list -->
                                    </div>
                                </div>
                        ...
                        <div class="col-md-10 col-md-offset-1">
                            <ul id="menu-pricing" class="menu-price">
                                 ...
                                 <li class="item dinner" id="{{$item->category->slug}}">
                                        ...
                                        <a href="#">
                                            <img src="{{asset('upload/item/'.$item->image)}}" class="img-responsive" alt="Item" 
                                            style="height:300px; width:369">
                ...
                <div class="row">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="copyright text-center">
                            <p>
                                &copy; Copyright, 2020 <a href="#">Mama's Kitchen.</a> Developed by <a href="#">Mahmudul Hasan Sajib</a>
                            </p>
                        </div>
                    </div>
                </div>
